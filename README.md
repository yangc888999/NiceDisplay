...
界面参考 BetterDisplay；纯小白用 Workbuddy 手搓，仅通过自测。放出源码供其他小伙伴参考,**不对任何使用过程中出现的任何问题负责，请谨慎安装使用**。
...
- **保留 F7/F8/F9 播放控制**：切到"标准功能键"模式后，直按 F7/F8/F9 仍能上一曲 / 播放暂停 / 下一曲
  （工具会把标准键码转发成系统媒体事件；可在 设置 → 高级 里关闭）
- **设置页内直接配置键盘**：「将 F1/F2 作为标准功能键」可直接勾选，无需手动去系统设置
